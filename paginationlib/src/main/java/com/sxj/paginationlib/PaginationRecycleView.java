...
public class PaginationRecycleView extends LinearLayout implements PaginationIndicator.OnChangedListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int textSize = a.getDimensionPixelSize(R.styleable.PaginationIndicator_text_size, PaginationIndicator.sp2px(getContext(), 16));
        int width = a.getDimensionPixelSize(R.styleable.PaginationIndicator_rect_size, 0);

        if (width == 0) {
            width = PaginationIndicator.dp2px(getContext(), 32);
        }
        a.recycle();
